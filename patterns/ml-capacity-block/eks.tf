...
data "aws_ssm_parameter" "eks_al2_gpu" {
  name = "/aws/service/eks/optimized-ami/${local.cluster_version}/amazon-linux-2-gpu/recommended/image_id"
}
...
module "eks" {
  ...
  self_managed_node_groups = {
    odcr = {
      ...
      ami_id        = nonsensitive(data.aws_ssm_parameter.eks_al2_gpu.value)
